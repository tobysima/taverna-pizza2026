...
const rows = [
  {
    label: 'Address',
    value: '427 N 300 W, Salt Lake City, UT 84103',
    sub: 'Free street parking available nearby',
    href: 'https://www.google.com/maps/search/?api=1&query=427+N+300+W+Salt+Lake+City+UT+84103',
  },
  {
    label: 'Hours',
    value: 'Tue – Sun · Lunch & Dinner',
    sub: 'Check taverna.pizza for current hours',
  },
  {
    label: 'Order Online',
    value: 'taverna.pizza',
    sub: 'Online ordering available for pickup & delivery',
    href: 'https://www.taverna.pizza',
  },
  {
    label: 'Instagram',
    value: '@taverna.pizza.slc',
    sub: 'Follow for specials and new menu items',
    href: 'https://www.instagram.com/taverna.pizza.slc/',
  },
]
  ...
  return (
    <section id="location" className="grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="relative min-h-[50vh] overflow-hidden border-l border-border bg-secondary lg:min-h-full">
        <iframe
          title="Map to Taverna Pizza, 427 N 300 W, Salt Lake City, UT 84103"
          src="https://www.google.com/maps?q=427+N+300+W+Salt+Lake+City+UT+84103&output=embed"
          loading="lazy"
